...
{
    public abstract class CrudOperationsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CrudOperationsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CrudOperationsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CrudOperationsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CrudOperationsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CrudOperationsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CrudOperationsDbContext, Task<T>> func)
        {
            T result;
